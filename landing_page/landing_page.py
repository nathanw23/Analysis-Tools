...
def landing_page():
    ...
    table_data = [
        ...
        ['plate_multiplex', 'Cleans up and plots multiplex kinetics data obtained from a ClarioStar plate reader'],
        ...
        ['fluor_multiplex', 'Plots multiplex kinetics fluorescent data from a Cary Eclipse Fluorescence Spectrophotometer'],
